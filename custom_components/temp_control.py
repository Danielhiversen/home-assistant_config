...
def setup(hass, config):
    ...
    input_slider.async_setup(hass, config)
...
def _setup(hass, config, target_entity, name, keep_on):
    ...
    group.Group.create_group(hass,name, ['input_boolean.' + object_id_enable, 'input_slider.' + object_id_hour, 'input_slider.' + object_id_temp])
